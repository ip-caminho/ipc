...
export function FinanceiroSection({
  ...
  const removerReceb = useMutation(api.acampamento.mutations.removerRecebimento);
  const conceder = useMutation(api.acampamento.mutations.concederDesconto);
  ...
  const resumoEvento = useQuery(
    api.acampamento.queries.resumoFinanceiro,
    descontoOpen ? { id: acampamentoId } : "skip",
  );
        ...
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <FileUpload
                folder="acampamento-comprovantes"
