      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="right" className="sm:max-w-md overflow-y-auto">
          ...
          <div className="mt-6 px-3 space-y-2">
            ...
            {!temCeia && (
              <div className="flex items-center gap-2 rounded-lg border border-yellow-300 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-950/30 px-3 py-2 text-xs text-yellow-700 dark:text-yellow-400">
