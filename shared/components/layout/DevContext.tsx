...
const CONTEXT_MAP: Record<string, PageContext> = {
  "/dashboard": {
    ...
    arquivos: [
      ...
      "features/dashboard/components/PerfilDesatualizadoCard.tsx",
    ...
    queries: ["gravacoes.queries.list", "gravacoes.queries.getLatestAvisos", "membros.selfService.getMyProfile", "membros.queries.birthdaysThisMonth"],
    mutations: ["membros.bootstrap.bootstrapAdmin"],
    componentes: ["UltimoSermaoCard", "PerfilDesatualizadoCard", "TodaySection", "BirthdayList", "SectionLabel", "AvisosWidget (drawer)", "BootstrapForm"],
    notas: [
      "Hierarquia: saudacao → perfil desatualizado (amber, condicional) → ultimo sermao → Hoje (avisos) → aniversariantes",
      "UltimoSermaoCard: link para pregacao mais recente publicada",
      "PerfilDesatualizadoCard: aparece quando perfilAtualizadoEm > 6 meses ou nunca confirmado",
