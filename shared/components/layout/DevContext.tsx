...
const CONTEXT_MAP: Record<string, PageContext> = {
  ...
  "/membros/[id]": {
    ...
    queries: ["membros.queries.getById", "membros.eclesiastico.getFamily", "membros.familia.redeFamiliar", "membros.acesso.getStatusAcesso"],
    ...
    componentes: ["DadosBasicosSection", "EclesiasticoForm", "MembroForm", "AcessoSection", "AtosPastoraisSection", "CargosHistoricoSection", "FamiliaArvoreSection", "ArvoreFamiliar", "PermissionGate"],
    notas: [
      "Detalhe UNICO do membro (fold de /membros/[id]). Gate externo: rol:read + ModuloGuard modulo=membros",
      "Arvore familiar (FamiliaArvoreSection -> ArvoreFamiliar, D3): read-only, rede derivada de membros.conjugeId + tabela responsaveis via redeFamiliar (BFS). So aparece com rede > 1 pessoa",
