...
const CONTEXT_MAP: Record<string, PageContext> = {
  ...
  "/calendario": {
    ...
    componentes: ["CalendarioMes/Semana/Lista", "EventoForm", "PermissionGate", "ModuloGuard"],
    notas: [
      "Permissao: calendario:read/create/update/delete",
      "3 visoes: Mes (grade 7 col c/ dias da semana), Semana, Lista. Estado na URL via nuqs (?view=)",
      "Navegacao por mes (mes/lista) ou semana (semana); botao Hoje. Filtro por ministerio",
