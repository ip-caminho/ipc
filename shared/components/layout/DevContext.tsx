...
const CONTEXT_MAP: Record<string, PageContext> = {
  ...
  "/pedidos-oracao": {
    ...
    arquivos: [
      ...
      "features/pedidosOracao/components/PedidoOracaoDetalhe.tsx (legado — Fase 3 vira rota)",
    ...
    notas: [
      ...
      "Detalhe do pedido ainda usa PedidoOracaoDetalhe legado; Fase 3 vira rota /pedidos-oracao/[id] + UpdateTimeline",
