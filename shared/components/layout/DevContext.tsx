...
const CONTEXT_MAP: Record<string, PageContext> = {
  "/": {
    ...
    queries: ["gravacoes.queries.getLatestAvisos", "membros.queries.birthdaysThisMonth", "pastoreio.queries.listPedidosOracao"],
    mutations: ["membros.bootstrap.bootstrapAdmin"],
    componentes: ["AvisosWidget (usa player global)", "FrasesCarrossel", "BootstrapForm"],
    notas: [
  ...
  "/diretorio": {
    ...
    componentes: ["MembroFicha (inline)", "ModuloGuard"],
    notas: [
      "Permissao: diretorio:read",
      "Filtros: Todos, Membros, Obreiros, Pastores e Presbiteros",
      "Cards com apelido, foto, cargo. Sem WhatsApp no card",
      "Contagem de membros no header, ordenacao alfabetica",
      "Ficha (Sheet ao clicar): foto, WhatsApp, aniversario, profissao, bairro, membro desde, conjuge, filhos, PG",
    ],
  },
  "/gravacoes": {
