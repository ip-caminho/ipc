...
const CONTEXT_MAP: Record<string, PageContext> = {
  ...
  "/educacional": {
    ...
    notas: [
      "Permissao: criancas:read/manage, educacional:read/write, voluntarios_edu:read/manage",
