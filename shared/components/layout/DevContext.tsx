...
const CONTEXT_MAP: Record<string, PageContext> = {
  ...
  "/gravacoes/[id]": {
    ...
    arquivos: [
      ...
      "shared/offline/OfflineProvider.tsx",
      "shared/offline/db.ts",
      "shared/offline/rangeSermao.ts",
      "shared/audio/VelocidadeButton.tsx",
    ],
    ...
    componentes: [
      ...
      "IaStatusBadge",
      "ShareGravacaoButton",
      "OfflineToggle (guardar audio no aparelho)",
      "VelocidadeButton (no player global)",
    ],
    notas: [
      "Ouvir offline: OfflineToggle baixa so o trecho do sermao (Range no CDN, MP3 CBR) para IndexedDB; o player toca o blob local e cai para o CDN se o arquivo local falhar",
      "Velocidade 1x-2x no player global, preferencia em localStorage (ipc:audio:playbackRate)",
