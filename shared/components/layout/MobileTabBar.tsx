...
const drawerSections: DrawerSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Equipes", href: "/escalas/equipes", icon: Users, permission: "escalas:update", modulo: "escalas" },
      { label: "Gerar Escalas", href: "/escalas/gerar", icon: CalendarCheck, permission: "escalas:update", modulo: "escalas" },
